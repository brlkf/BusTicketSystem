...
<html>
    ...
    <body>
        ...
        <br>
        <form action="view_ticket.php" method="POST" align="center">
            <div>
                <input name="date" type="text" placeholder="Departure Date"
                onfocus="(this.type='date')">
                <Select name="From" required="required" placeholder="From">
                ...
                <Select name="To" required="required" placeholder="To">
