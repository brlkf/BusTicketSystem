...
<body>
    ...
    <div class="wordalign">
        <h2>Bus from 
        <i><?php echo $_POST['From'];?></i>
        to
        <i><?php echo $_POST["To"];?></i>
        
            Date:<i><?php echo $_POST['date'];?></i>
        </h2>
        <form method="POST" action="view_all_ticket(logged_in).php">
            <button class="view_ticket">View all ticket</button>
        </form>
    </div>
    ...
    <table  class = table align = center>
        ...
        <tbody>
            ...
            bus b ON bt.Bus_ID = b.Bus_ID WHERE Departure_point LIKE '$from' OR Arrival_point LIKE'$to' OR Departure_date LIKE'$date'");
